...
from .views import SimulationDetailView, SimulationListView, TeamsSelectionView, SimulationCreate, SimulationUpdate, \
    ...
    MarketView, SimulationInfoUpdate, company_shares_export_xlsx
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<simulation_id>\d+)/company-shares/export/$', company_shares_export_xlsx, name='company-shares-export-xlsx-simulation'),
