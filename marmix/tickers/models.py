...
class Ticker(TimeStampedModel):
    ...
    # Fields for indexed simulation
    gameid = models.IntegerField(verbose_name=_("MarMix game id"), null=True, blank=True,
                                 help_text=_("For example: 8"))
    userkey = models.CharField(verbose_name=_("MSSQL username"), max_length=30, null=True, blank=True,
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.userkey:
            self.userkey = re.sub(r'\W+', '', '%s%s' % (self.simulation.customer.short_code.upper(), self.simulation_id))
